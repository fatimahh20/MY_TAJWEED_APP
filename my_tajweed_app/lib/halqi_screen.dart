...
class HalqiScreen extends StatefulWidget {
  const HalqiScreen({super.key});

  @override
  State<HalqiScreen> createState() => _HalqiScreenState();
}
class _HalqiScreenState extends State<HalqiScreen> {
  ...
  final List<Map<String, String>> words = const [
    {"text": " عَنْهُمْ", "audio": "assets/sounds/abad.mp3"},
    {"text": "اَنْعَمْتَ", "audio": "zabar/akhaza.mp3"},
    {"text": "لِمَنْ خَشِيَ", "audio": "zabar/baas.mp3"},
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            _bullet("  درجہ ذیل حروف ِ حلقی ہیں۔                                   ء،ہ،ع،ح،غ،خ۔"),
            _bullet("یہ حروف حلق کے مختلف حصّوں سے  ادا کیے جاتے ہیں۔     "),
