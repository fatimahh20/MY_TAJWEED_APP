...
class LeenScreen extends StatefulWidget {
  const LeenScreen({super.key});

  @override
  State<LeenScreen> createState() => _LeenScreenState();
}
class _LeenScreenState extends State<LeenScreen> {
  ...
  final List<Map<String, String>> words = const [
    {"text": "عَلَيْهِ", "audio": "assets/sounds/abad.mp3"},
    {"text": "مِنْ خَوْفٍ", "audio": "zabar/akhaza.mp3"},
    {"text": "اَلْبَيْتِ", "audio": "zabar/baas.mp3"},
    {"text": "قُرَيْشٍ", "audio": "zabar/sarafa.mp3"},
    {"text": "شَيْءٍ", "audio": "zabar/sharaha.mp3"},
  ];
        ...
        child: Column(
          children: [
           const SizedBox(height:20),
            _bullet("ایسا  ‘و         ساکن یا     ی                               ساکن  ’  جس کےپچھلے  حرف پر               زبر ہو،  ایک الف کے برابر لمبا                                    پڑھا جاتا ہے۔ "),
